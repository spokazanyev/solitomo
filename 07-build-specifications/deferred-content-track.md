...
Дата создания: 2026-05-16. Последнее обновление: 2026-05-19.
...
- [Часть Б. Cart and checkout (037)](#часть-б-cart-and-checkout-037) — пункт 15
...
- **SMTP / email-сервис** для отправки PDF-счетов и нотификаций. Варианты: Resend / собственный SMTP / Mailgun. Адрес отправителя, реквизит для DMARC.
...
3. Получить SMTP для уведомлений Twenty (можно переиспользовать SMTP-реквизиты из пункта 15, Cart-and-checkout).
