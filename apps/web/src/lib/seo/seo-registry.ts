...
export const seoRoutes: SeoRoute[] = [
  ...
  },
  {
    ...
    description:
      "Действующие сертификаты ТР ТС и декларации ЕАЭС на серийный выпуск блоков розеток и PDU Солитон. Срок действия — до 30 июля 2030 года.",
    demandCluster: "Trust",
    priority: 0.5,
    changeFrequency: "monthly",
    indexable: true,
    ...
    summary:
      "Сертификаты соответствия ТР ТС и декларации ЕАЭС покрывают серийный выпуск всей линейки блоков розеток Солитон — версии M&C, IEC320 C13/C19, модели с УЗИП. Файлы можно скачать ниже или приложить к КП.",
    cta: "Запросить копию для тендера",
  },
  {
