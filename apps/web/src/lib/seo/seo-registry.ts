...
export const seoRoutes: SeoRoute[] = [
  ...
  },
  {
    ...
    title: "PDU и блоки распределения питания Солитон",
    description:
      "Каталог PDU Солитон: блоки распределения питания для стоек 19 дюймов, серверных шкафов, ЦОД и телеком-инфраструктуры.",
    demandCluster: "PDU / блоки распределения питания",
    priority: 0.95,
    changeFrequency: "weekly",
    indexable: true,
    keywords: ["pdu", "блок pdu", "pdu розетки", "блок розеток pdu"],
    summary:
      "Каталог PDU с подбором по монтажу, току, типу розеток и функциям для стоек и серверных шкафов.",
    cta: "Подобрать PDU",
  },
  {
